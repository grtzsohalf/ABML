from core.solver_ordered import CaptioningSolver
from core.model_ordered import CaptionGenerator
...
def main():
    ...
    solver.test(split='val', filename=filename, attention_visualization=False, thres=float(thres))
