from core.solver_y_p import CaptioningSolver
from core.model_y_p import CaptionGenerator
...
def main():
    ...
    idx_to_word[1] = '<START>'
    idx_to_word[2] = '<END>'
    model = CaptionGenerator(word_to_idx, idx_to_word, dim_feature=[196, 1024], dim_embed=64,
    ...
    solver = CaptioningSolver(model, data_path, n_epochs=20, batch_size=128,
                ...
                pretrained_model='model/lstm/mscoco_recursive_concat-20', model_path='model/lstm/',
