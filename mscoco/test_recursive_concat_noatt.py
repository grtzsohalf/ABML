from core.solver_recursive_concat_noatt import CaptioningSolver
from core.model_recursive_concat_noatt import CaptionGenerator
...
def main():
    ...
    solver.test(split='test', filename=filename, attention_visualization=False, thres=float(thres))
