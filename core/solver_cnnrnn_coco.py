...
class CaptioningSolver(object):
    ...
    def train(self):
        ...
        generated_captions = self.model.build_sampler(max_len=15)
        ...
        with tf.Session(config=config) as sess:
            ...
            for e in range(self.n_epochs):
                ...
                if (e+1) % self.save_every == 0:
                    saver.save(sess, os.path.join(self.model_path, 'coco_cnnrnn'), global_step=e+1)
                    print "coco_cnnrnn-%s saved." %(e+1)
    ...
    def test(self, data, split='train', attention_visualization=True, save_sampled_captions=True,\
        ...
        with tf.Session(config=config) as sess:
            ...
            for thres_iter in range(1):
                ...
                save_pickle(all_sam_cap, "./cocodata/%s/%s.candidate.captions_%s.pkl" % \
