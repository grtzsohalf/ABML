...
def main():
    ...
    idx_to_word[1] = '<START>'
    idx_to_word[2] = '<END>'
    val_data = load_coco_data(data_path='./cocodata', split='val_small')
    ...
    solver.test(val_data, split='val_small', filename=filename, attention_visualization=False, thres=float(thres))
