from core.solver_2_bpmll import CaptioningSolver
from core.model_2_bpmll import CaptionGenerator
...
def main():
    ...
    data_path = './data'
    solver = CaptioningSolver(model, data_path, val_data, n_epochs=30, batch_size=128,
                update_rule='adam', learning_rate=0.0005, print_every=30, save_every=1,
