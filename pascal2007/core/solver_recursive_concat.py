        ...
        with tf.Session(config=config) as sess:
            ...
            for e in range(self.n_epochs):
                ...
                if (e+1) % self.save_every == 0:
                    saver.save(sess, os.path.join(self.model_path, 'pascal_recursive_concat'), global_step=e+1)
                    print "pascal_recursive_concat-%s saved." %(e+1)
                ...
                for i in range(num_iter):
                    ...
                    for t in range(MAX_LEN): # time step
                        ...
                        if t == 0:
                            ...
                            path, c_run, h_run, alphas, samp_run, y_run, p_run = paths_info[0]
                            feed_dict = { self.model.features: features_batch,
                                            self.model.init_pred: init_pred_batch,
                                            self.model.c: c_run,
                                            self.model.h: h_run,
