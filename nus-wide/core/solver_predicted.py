        ...
        with tf.Session(config=config) as sess:
            ...
            for e in range(self.n_epochs):
                ...
                if (e+1) % self.save_every == 0:
                    saver.save(sess, os.path.join(self.model_path, 'pascal'), global_step=e+1)
                    print "pascal-%s saved." %(e+1)
                '''
                arr = np.arange(8)
                ...
                # save model's parameters
                if (e+1) % self.save_every == 0:
                    saver.save(sess, os.path.join(self.model_path, 'mscoco_pascal_0.0001'), global_step=e+1)
                    print "mscoco_pascal_0.0001-%s saved." %(e+1)
    ...
    def test(self, data, split='train', attention_visualization=True, save_sampled_captions=True,\
        ...
        with tf.Session(config=config) as sess:
            ...
            if attention_visualization:
                ...
                reference = load_pickle('./cocodata/val/val.references81.pkl')
