...
def main():
    ...
    train_dataset = _process_caption_data(caption_file='/home/jason6582/sfyc/NUS-WIDE/train_aug.json',
                                          image_dir='/home/jason6582/sfyc/NUS-WIDE/flickrfeature_aug/',
                                          max_length=max_length)
    val_dataset = _process_caption_data(caption_file='/home/jason6582/sfyc/NUS-WIDE/val_aug.json',
                                          image_dir='/home/jason6582/sfyc/NUS-WIDE/flickrfeature_aug/',
                                          max_length=max_length)
    cutoff = len(train_dataset) / 95
    train_data = train_dataset
    val_data = val_dataset[:cutoff]
    test_data = val_dataset[cutoff:]
